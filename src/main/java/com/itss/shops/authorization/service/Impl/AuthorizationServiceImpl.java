...
import com.itss.shops.common.exception.ErrorResponse;
import com.itss.shops.common.exception.RestException;
import com.itss.shops.common.utils.HashUtils;
...
//		List<String> scopes = new ArrayList<>();
	...
	@Override
	public AccountResponse getAuthenticatedUser() {
		String userName;
		...
		if(StringUtils.isNotEmpty(userName)) {
			...
			MPBeanUtils.copyPropertiesIgnoreNull(account, accountResponse);
